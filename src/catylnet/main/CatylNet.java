/*
 * CatylNet.java Copyright (C) 2019. Daniel H. Huson
 *
...
public class CatylNet extends Application {
    ...
    protected static void parseArguments(String[] args) throws CanceledException, UsageException {
        ...
        if (ProgramProperties.isMacOS())
            defaultPropertiesFile = System.getProperty("user.home") + "/Library/Preferences/CatylNet.def";
        else
            defaultPropertiesFile = System.getProperty("user.home") + File.separator + ".CatylNet.def";
        ...
        if (showVersion) {
            ...
            System.err.println(jloda.util.Version.getVersion(CatylNet.class, ProgramProperties.getProgramName()));
