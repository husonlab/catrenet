/*
 * BioRAF.java Copyright (C) 2024 Daniel H. Huson
 *
...
public class BioRAF extends Application {
    ...
    public static void main(String[] args) throws CanceledException, UsageException {
        ...
        ResourceManagerFX.addResourceRoot(BioRAF.class, "bioraf.resources");
        ProgramProperties.getProgramIconsFX().addAll(ResourceManagerFX.getIcons("BioRAF-512.png"));
        ProgramProperties.setProgramName(Version.NAME);
        ProgramProperties.setProgramVersion(Version.SHORT_DESCRIPTION);
        ProgramProperties.setProgramLicence("""
                Copyright (C) 2024. his program comes with ABSOLUTELY NO WARRANTY.
                This is free software, licensed under the terms of the GNU General Public License, Version 3.
                Sources available at: https://github.com/husonlab/bioraf
                """);
    ...
    protected static void parseArguments(String[] args) throws CanceledException, UsageException {
        ...
        if (showVersion) {
            ...
            System.err.println(jloda.util.Version.getVersion(BioRAF.class, ProgramProperties.getProgramName()));
    ...
    public static String getDefaultPropertiesFile() {
        if (ProgramProperties.isMacOS())
            return System.getProperty("user.home") + "/Library/Preferences/BioRAF.def";
        else
