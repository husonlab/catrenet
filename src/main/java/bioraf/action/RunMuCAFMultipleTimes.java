/*
 * RunMuCAFMultipleTimes.java Copyright (C) 2024 Daniel H. Huson
 *
...
package bioraf.action;

import bioraf.algorithm.IDescribed;
import bioraf.algorithm.MuCAFAlgorithm;
import bioraf.main.Version;
import bioraf.window.MainWindow;
import bioraf.window.MainWindowController;
