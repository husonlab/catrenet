/*
 * CommandLineTool.java Copyright (C) 2024 Daniel H. Huson
 *
...
package bioraf.tools;

import bioraf.action.ImportWimsFormat;
import bioraf.algorithm.AlgorithmBase;
import bioraf.algorithm.MinIRAFHeuristic;
import bioraf.io.ModelIO;
import bioraf.main.BioRAF;
import bioraf.model.ReactionSystem;
import bioraf.settings.ArrowNotation;
import bioraf.settings.ReactionNotation;
...
public class CommandLineTool {
	...
	public static void main(String[] args) {
		try {
			ResourceManagerFX.addResourceRoot(bioraf.resources.Resources.class, "bioraf.resources");
			ProgramProperties.setProgramName(CommandLineTool.class.getSimpleName());
			ProgramProperties.setProgramVersion(bioraf.main.Version.SHORT_DESCRIPTION);
	...
	private void run(String[] args) throws IOException, UsageException {
		...
		final var propertiesFile = options.getOption("-P", "propertiesFile", "Properties file", BioRAF.getDefaultPropertiesFile());
		options.done();
